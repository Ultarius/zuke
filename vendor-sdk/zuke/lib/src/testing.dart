...
String defaultZukeDescription(ZukeScenarioContract scenario, String? caseId) {
  final caseSuffix =
      caseId != null && caseId.isNotEmpty && caseId != scenario.id.value
      ? ' ($caseId)'
      : '';
  return 'Zuke ${scenario.id.value}$caseSuffix: ${scenario.title}';
}
...
void zukeTest(
  ...
  final effectiveDescription =
      description ?? defaultZukeDescription(scenario, caseId);
